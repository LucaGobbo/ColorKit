...
class PaletteViewController: UIViewController {
    ...
    private let albums = [
        Album(
            image: #imageLiteral(resourceName: "Album_cover_1"), name: "My Beautiful Dark Twisted Fantasy",
            artist: "Kanye West"),
        ...
        Album(
            image: #imageLiteral(resourceName: "Album_cover_4"), name: "Never Mind the Bollocks", artist: "Sex Pistols"),
        Album(
            image: #imageLiteral(resourceName: "Album_cover_5"), name: "The Dark Side of the Moon", artist: "Pink Floyd"
        ),
