...
struct AverageColorTests {
    ...
    @Test func greenImage() throws {
        ...
        let nativeImage = try #require(NativeImage(named: "Green_Square.jpg", in: bundle, with: nil))
    ...
    @Test func purpleImage() throws {
        let bundle = Bundle.module
        let nativeImage = try #require(NativeImage(named: "Purple_Square.jpg", in: bundle, with: nil))
        let image = Image(nativeImage: nativeImage)
        let averageColor = try image.averageColor()
