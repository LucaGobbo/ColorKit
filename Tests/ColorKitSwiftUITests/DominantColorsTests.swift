...
struct DominantColorsTests {
    ...
    struct SwiftUIImage {
        ...
        func check(color: Color, red: CGFloat = 0, green: CGFloat = 0, blue: CGFloat = 0, accuracy: CGFloat = 0) -> Bool {
            ...
            areFloatsEqual(color.red, red, accuracy: accuracy) &&
            areFloatsEqual(color.green, green, accuracy: accuracy) &&
        ...
        @Test func redBlueGreenImage() throws {
            ...
            #expect(dominantColors.count == 3)
            #expect(dominantColors.contains(where: { color in check(color: color, red: 1, green: 0, blue: 0, accuracy: 0.1) }))
            #expect(dominantColors.contains(where: { color in check(color: color, red: 0, green: 1, blue: 0, accuracy: 0.1) }))
            #expect(dominantColors.contains(where: { color in check(color: color, red: 0, green: 0, blue: 1, accuracy: 0.1) }))
            verifySorted(colorsFrequencies: colorFrequencies)
        }
        @available(iOS 16.0, *)
        @Test func redBlueGreenBlack() throws {
